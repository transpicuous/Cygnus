...
CREATE TABLE IF NOT EXISTS `gw_characterstat` (
  ...
  `nFatigue` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  `nAlbaActivityID` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `AlbaStartTimeHigh` int(11) NOT NULL DEFAULT '0',
  `AlbaStartTimeLow` int(11) NOT NULL DEFAULT '0',
  `nAlbaDuration` int(11) NOT NULL DEFAULT '0',
  `bAlbaSpecialReward` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `gw_itemslotequip` (
  ...
  `dateExpireHigh` int(11) NOT NULL DEFAULT '0',
  `nBagIndex` int(11) NOT NULL DEFAULT '0',
  `nPrevBonusExpRate` int(11) NOT NULL DEFAULT '0',
  `sTitle` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vSlot` tinyint(1) NOT NULL DEFAULT '0',
